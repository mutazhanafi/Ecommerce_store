                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">
                                        {{__('admin/product.manage_stock')}} </a>
                                </li>
                                <li class="breadcrumb-item active"> {{__('admin/product.add_manage_stock')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/product.add_manage_stock')}} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{__('admin/product.product_code')}}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/product.Track the stock')}}
                                                            </label>
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label=" {{__('admin/product.please_select_price_type')}}">
                                                                    <option value="1">{{__('admin/product.Tracking Enabled')}}</option>
                                                                    <option value="0" selected>{{__('admin/product.Tracking not enabled')}}</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{__('admin/product.Tracking status')}}
                                                            </label>
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label=" {{__('admin/product.please_select')}}">
                                                                    ...
                                                                    <option value="0"> {{__('admin/product.not_Available')}} </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
