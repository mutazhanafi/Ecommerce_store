        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                                        <h3 class="content-header-title">  {{__('admin/product.pro_opions')}}</h3>
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin/product.all_opions')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/product.all_opions')}}</h4>
                                    ...
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/product.pro')}}</th>
                                                <th>{{__('admin/product.attri')}}</th>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.options.delete',$option -> id)}}"
                                                                   class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">{{__('admin/product.delete')}}</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endforeach
