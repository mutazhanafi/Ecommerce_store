                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/product.add_opions')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/product.add_opions')}}</h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>{{__('admin/product.information_options')}} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
   ...
   @foreach($products as $product)<option  value="{{$product -> id }}">{{$product -> name}}</option> @endforeach   @endif
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary ">
                                                    <i class="la la-check-square-o"></i> {{__('admin/product.save')}}                                                </button>
                                            </div>
                                        </form>
