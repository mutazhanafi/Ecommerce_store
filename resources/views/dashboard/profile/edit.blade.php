                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$admin -> name  }}" id="name"
                                                                   ...
                                                                   name="name">
                                                            @error("name")
                                                            <span class="text-danger">{{__('admin/profile.error name')}} </span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$admin -> email  }}" id=""
                                                                   ...
                                                                   name="email">
                                                            @error("email")
                                                            <span class="text-danger">{{__('admin/profile.error email')}} </span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" value="" id=""
                                                                   ...
                                                                   name="password">
                                                            @error("password")
                                                            <span class="text-danger">{{__('admin/profile.error new password')}}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
