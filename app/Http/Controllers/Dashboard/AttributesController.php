 ...
 public function store(AttributeRequest $request)
    {
        ...
        $attribute->save();
        DB::commit();
        return redirect()->route('admin.attributes')->with(['success' => __('admin/maincatogries.message_success_add')]);
  ...
  public function edit($id)
    {
        ...
        if (!$attribute)
            return redirect()->route('admin.attributes')->with(['error' => __('admin/maincatogries.message_error-not found')]);
    ...
    public function update($id, AttributeRequest $request)
    {
        try {
            ...
            DB::commit();
            return redirect()->route('admin.attributes')->with(['success' => __('admin/maincatogries.message_success')]);
